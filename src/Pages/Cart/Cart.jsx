...
import { deleteFormcart } from '../../Redux/CartSlice';
...
function Cart() {
  ...
  return (
    <Layout>
      <div
        className=" bg-gray-100 pt-5 py-20 "
        style={{
          backgroundColor: mode === "dark" ? "#282c34" : "",
          color: mode === "dark" ? "white" : "",
        }}
      >
        <h1 className="text-center text-2xl font-bold md:mb-10 mb-4">
          Cart Items
        </h1>

        <div
          className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 
      xl:px-0 "
        >
          {/* left-side */}
          <div className="md:w-2/3 rounded-lg flex flex-col gap-4">
            {cartitems.map((item, index) => {
              const { title , imageUrl , price , description , } = item
              return (
                <div key={index}
                  className=" justify-between rounded-lg  border drop-shadow-xl 
